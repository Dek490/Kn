...
//     const content = await RNPrint.print({
//       html:
//       `
//       <html>
//         <head>
...
//           <style>
//             /* Additional styles for centering text content */
//             body {
            
//               font-family: Arial, sans-serif; /* Specify desired font family */
//             }
//             .printable-content {
//               width: 80%; /* Adjust width as needed */
//               text-align: center; /* Center-align text content */
//               /* Add other styles to maintain the original design */
//             }
//             /* Example style for table content alignment */
//             .table-content {
//               margin: 0 auto; /* Center-align table content */
//               /* Add other table-specific styles */
//             }
//           </style>
//         </head>
//         <body>
//           <div class="printable-content">${<PrintableInvoice/>}</div>
//         </body>
//       </html>`,
//     });
//     console.log(content);
...
//               <Text style={styles.totalText}>Total Amount:</Text><Text style={{textAlign:'right',marginRight:15,fontWeight:'bold'}}>1000</Text>
...
const handlePrint = async () => {
  if (RNPrint) {
    // RNPrint is available, proceed with printing
    try {
    ...
    console.log("RNPrint is not available");
  }
};
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.subcontainer}>
        <View style={styles.itemsHeaderContainer} id="printableContent">
          <FontAwesome5 name="list" style={styles.itemsIcon} />
          <Text style={styles.itemsTxtTitle}>
            Today's <Text style={{ color: "#449964" }}>Invoice</Text>
          </Text>
        </View>
                      ...
                      data={[
                        ...
                        ItemID == null ? (
                          ...
                          <TextInput
                            ...
                            onChangeText={(text) =>
                              handleQtyChange(rowData._id, text)
                            }
                          />
                        ) : (
                          <Text style={styles.PriceQty}>
                        ...
                        <View style={styles.actions}>
                          <TouchableOpacity
                            onPress={() =>
                              handleQtyEdit(rowData._id, rowData.ItemId)
                            }
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            <View style={styles.modalButtons}>
              <TouchableOpacity
                onPress={() => setmodalVisibleForViewInv(false)}
              >
