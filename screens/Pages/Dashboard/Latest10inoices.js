...
import Latest10inoicesList from "./Latest10inoicesList";
import { debounce } from 'lodash';


const Latest10inoices = () => {
  ...
  const fetchData = async () => {
      try {
          const response = await axios.get("/orders/all-invoices");
...
export default Latest10inoices;
