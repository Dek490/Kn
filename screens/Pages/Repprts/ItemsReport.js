...
// import ItemsReportList from "./ItemsReportList";
...
//     useEffect(() => {
//         fetchItemsReportByCategory();
//         fetchCategories();
//     }, []);

//     const fetchItemsReportByCategory = async (categoryId) => {
//         try {
//             const response = await axios.get(`/items/category/${categoryId}/report`, {
//                 params: {
//                     fromDate: fromDate,
//                     toDate: toDate
//                 }
...
//         } catch (error) {
//             console.error("Error fetching items report by category:", error);
//         }
//     };

//     useEffect(() => {
//         if (selectedCategory) {
//             fetchItemsReportByCategory(selectedCategory);
//         }
...
//                         ItemsReport <Text style={{ color: "#449964" }}>List</Text>
//                     </Text>
//                 </View>
        ...
        <SafeAreaView style={styles.container}>
            <View style={styles.subcontainer}>
                <View style={styles.itemsHeaderContainer}>
                    <FontAwesome5 name="list" style={styles.itemsIcon} />
                    <Text style={styles.itemsTxtTitle}>
                        Items Report <Text style={{ color: "#449964" }}>List</Text>
                    </Text>
                </View>
